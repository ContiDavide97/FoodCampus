                                            ...
                                            <div class="row product">
                                                ...
                                                <div class="col-sm-2">
                                                    <span <?php if ($isSupplier) { echo "data-toggle='popover' data-trigger='hover' data-content='I fornitori non possono acquistare'"; } ?>>
                                                        <button type="button" value="<?php echo $product['IDProdotto'];?>" class="btn btn-deafult btn-kart add-cart" <?php if ($isSupplier) { echo "style='pointer-events: none;' disabled"; } ?>><strong class="fas fa-cart-plus"></strong></button>
                                                    </span>
                                                </div>
                                            </div>
                                            <?php
