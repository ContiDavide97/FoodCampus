$(function() {
    ...
    $("#saveShippingCosts").click(function() {
        ...
        if ($.isNumeric(shippingCosts) && shippingCosts >= 0 && shippingCosts <= 10) {
            updateUserInformationAndSwitchFromDivToDiv("newShippingCosts", "shippingCosts", "costi_spedizione", shippingCosts, "newSupplierShippingCosts", "supplierShippingCosts", "../../commonParts/php/changeUserInformation.php", function(inf) {
                $("#costError").html();
