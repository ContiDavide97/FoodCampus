<?php
    ...
    $sqlRows = "SELECT * FROM fornitore WHERE bloccato = TRUE";
					...
					<?php
						if($resultRows->num_rows == 0) {
						    ...
						    while($row = mysqli_fetch_array($resultRows)) {
						        ...
						        echo "<td><button type='button' class='btn btn-primary unlock-supplier-button' value='".$row["IDFornitore"]."'>Sblocca</button></td>";
